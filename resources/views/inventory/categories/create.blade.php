        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select id="tax_rate_applicable" name="tax_rate_applicable"
                                            ...
                                            <option value="0" {{ old('tax_rate_applicable') == 0 ? 'selected' : '' }}>
                                                0% (Exempt)</option>
                                            <option value="5" {{ old('tax_rate_applicable') == 5 ? 'selected' : '' }}>
                                                5%</option>
                                            <option value="12"
                                                {{ old('tax_rate_applicable') == 12 ? 'selected' : '' }}>12%</option>
                                            <option value="18"
                                                {{ old('tax_rate_applicable') == 18 ? 'selected' : '' }}>18%</option>
                                            <option value="28"
                                                {{ old('tax_rate_applicable') == 28 ? 'selected' : '' }}>28%</option>
                                        </select>
                                        <div
                                            class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-700">
                                            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20"
                                    ...
                                    <p class="mt-2 text-sm text-gray-500">Default GST rate for products in this category
                                    </p>
                ...
                <div class="lg:col-span-1">
                        ...
                        <div class="p-5">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                        <ul class="space-y-2 text-sm text-gray-700">
                                            <li class="flex items-start">
                                                <span
                                                    class="inline-block w-2 h-2 bg-gray-400 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                                ...
                                <div>
                                    ...
                                    <div class="bg-blue-50 rounded-lg p-4 border border-blue-100">
                                        <ul class="space-y-2 text-sm text-gray-700">
                                            <li class="flex items-start">
                                                <span
                                                    class="inline-block w-2 h-2 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                                                <span>Electronics (Parent)</span>
                                            </li>
                                            <li class="flex items-start ml-4">
                                                <span
                                                    class="inline-block w-2 h-2 bg-blue-400 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                                                <span>Mobile Phones (Child)</span>
                                            </li>
                                            <li class="flex items-start ml-8">
                                                <span
                                                    class="inline-block w-2 h-2 bg-blue-300 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            ...
                            <div class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="flex items-start">
                                    <svg class="w-5 h-5 text-gray-400 mt-0.5 mr-2 flex-shrink-0" fill="none"
                                    ...
                                    <p class="text-sm text-gray-600">
                                        <span class="font-medium">Tip:</span> Use hierarchical structures for better
                                        Company of related products.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Quick Tips Card -->
                    <div
                        class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm border border-blue-100 overflow-hidden">
                        ...
                        <div class="p-5">
                            <ul class="space-y-3">
                                <li class="flex items-start">
                                    <span
                                        class="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                                        <span class="text-xs font-medium text-blue-800">1</span>
                                    </span>
                                    <p class="text-sm text-gray-700">Keep category codes short and memorable (max 4-5
                                        characters)</p>
                                </li>
                                <li class="flex items-start">
                                    <span
                                    ...
                                    <p class="text-sm text-gray-700">Use parent categories to create logical hierarchies
                                    </p>
                                </li>
                                <li class="flex items-start">
                                    <span
                                    ...
                                    <p class="text-sm text-gray-700">Set appropriate tax rates to simplify product setup
                                    </p>
                                </li>
                                <li class="flex items-start">
                                    <span
                                    ...
                                    <p class="text-sm text-gray-700">Clear descriptions help other team members understand
                                        category purpose</p>
                                </li>
                            </ul>
                        </div>
