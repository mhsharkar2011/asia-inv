                ...
                <div class="p-6 sm:px-8 bg-white border-b border-gray-200">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="mt-4 md:mt-0 flex flex-wrap gap-3">
                            <!-- Quick Stats -->
                            <div
                                class="bg-gradient-to-r from-blue-50 to-blue-100 px-4 py-2 rounded-lg border border-blue-200">
                            ...
                            <div>
                                ...
                                <select name="sort" id="sort"
                                    ...
                                    <option value="created_desc"
                                        {{ !request('sort') || request('sort') == 'created_desc' ? 'selected' : '' }}>
                                        Newest First</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div
                                    class="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center mr-4">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                <div
                                    class="w-12 h-12 rounded-lg bg-gradient-to-br from-emerald-100 to-emerald-200 flex items-center justify-center mr-4">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                <div
                                    class="w-12 h-12 rounded-lg bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center mr-4">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                <div
                                    class="w-12 h-12 rounded-lg bg-gradient-to-br from-rose-100 to-rose-200 flex items-center justify-center mr-4">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                @php
                                                    $productImage =
                                                        $product->productImages->where('is_primary', true)->first() ??
                                                ...
                                                @if ($imageUrl)
                                                    <img class="h-10 w-10 rounded-lg object-cover"
                                                        src="{{ $imageUrl }}" alt="{{ $product->product_name }}"
                                                        onerror="this.onerror=null; this.src='data:image/svg+xml;base64,'">
                                                @else
                                                    <div
                                                        class="h-10 w-10 rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            ...
                                            // Determine status based on is_active and stock quantity
                                        ...
                                        @endphp
                                        <span
                                            class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $statusColors[$status] }}">
                                            {{ $statusLabels[$status] }}
                                        </span>
                                    </td>
...
@push('scripts')
    <script>
        ...
        function updateBulkActions() {
            ...
            if (count > 0) {
                document.getElementById('selectedCount').textContent = count + ' item' + (count > 1 ? 's' : '') +
                    ' selected';
