<nav x-data="{ open: false, dropdowns: {} }" class="bg-white shadow-lg border-b border-gray-100 sticky top-0 z-50">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:flex items-center space-x-1 ml-10">
                    ...
                    @if (Auth::user()->canAny([
                            ...
                            'view purchases',
                            'view sales',
                        ]) || Auth::user()->hasRole(['admin', 'super-admin', 'inventory-manager', 'sales-person']))
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                @if (Auth::user()->can('view categories') || Auth::user()->hasRole(['admin', 'super-admin', 'inventory-manager']))
                                ...
                                @if (Auth::user()->can('view suppliers') || Auth::user()->hasRole(['admin', 'super-admin', 'inventory-manager']))
                                ...
                                @if (Auth::user()->can('view purchases') || Auth::user()->hasRole(['admin', 'super-admin', 'inventory-manager']))
                                ...
                                @if (Auth::user()->can('view sales') ||
                                        Auth::user()->hasRole(['admin', 'super-admin', 'sales-person', 'inventory-manager']))
                                ...
                                @if (Auth::user()->can('manage inventory') || Auth::user()->hasRole(['admin', 'super-admin', 'inventory-manager']))
                    ...
                    @if (Auth::user()->canAny([
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                x-transition:leave-end="opacity-0 translate-y-2"
                                class="absolute top-full left-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                                @if (Auth::user()->can('view inventory reports') || Auth::user()->hasRole(['admin', 'super-admin', 'inventory-manager']))
                                ...
                                @if (Auth::user()->can('view purchase reports') || Auth::user()->hasRole(['admin', 'super-admin', 'inventory-manager']))
                                ...
                                @if (Auth::user()->can('view financial reports') || Auth::user()->hasRole(['admin', 'super-admin']))
                                ...
                                @if (Auth::user()->can('generate reports') || Auth::user()->hasRole(['admin', 'super-admin']))
                                    <div class="border-t border-gray-100 mt-2 pt-2">
                    ...
                    @if (Auth::user()->hasRole('super-admin') || Auth::user()->hasRole('admin'))
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                <div class="px-3 py-2">
                                    <span
                                        class="text-xs font-semibold uppercase text-gray-500 tracking-wider">Administration</span>
                                </div>

                                @if (Auth::user()->can('manage users') || Auth::user()->hasRole(['admin', 'super-admin']))
                                ...
                                @if (Auth::user()->can('manage companies') || Auth::user()->hasRole(['admin', 'super-admin']))
                                ...
                                @if (Auth::user()->can('manage roles') || Auth::user()->hasRole(['admin', 'super-admin']))
                                ...
                                @if (Auth::user()->hasRole('super-admin'))
                                    <div class="border-t border-rose-100 mt-2 pt-2">
                                        <div class="px-3 py-2">
                                            <span
                                                class="text-xs font-semibold uppercase text-rose-600 tracking-wider flex items-center">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" @click.away="open = false"
                            ...
                            @if ($unreadNotificationsCount = Auth::user()->unreadNotifications()->count())
                                <span
                                    class="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-br from-rose-500 to-pink-600 text-white text-xs rounded-full flex items-center justify-center animate-pulse">
                            ...
                            <div class="px-4 py-3 border-b border-gray-100">
                                <div class="flex items-center justify-between">
                                    ...
                                    @if ($unreadNotificationsCount)
                                        <span
                                            class="px-2 py-1 text-xs bg-gradient-to-r from-rose-50 to-pink-50 text-rose-600 rounded-full">
                            ...
                            @if ($unreadNotificationsCount)
                                <div class="max-h-96 overflow-y-auto">
                                    ...
                                    <div class="px-4 py-3 hover:bg-gray-50">
                                        <p class="text-sm text-gray-700">You have {{ $unreadNotificationsCount }}
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                        ...
                        <div class="px-4 py-3 border-b border-gray-100">
                            <div class="flex items-center space-x-3">
                                <div
                                    class="w-10 h-10 rounded-lg bg-gradient-to-br
                                    @if (Auth::user()->hasRole('super-admin')) from-rose-500 to-pink-600
                                    @elseif(Auth::user()->hasRole('admin')) from-blue-500 to-blue-600
                                    @elseif(Auth::user()->hasRole('inventory-manager')) from-emerald-500 to-emerald-600
                                    @elseif(Auth::user()->hasRole('sales-person')) from-purple-500 to-purple-600
                        ...
                        <div class="py-1">
                            ...
                            @if (Auth::user()->hasRole('super-admin'))
                                <a href="{{ route('admin.super.dashboard') ?? '#' }}"
                                    ...
                                    <div
                                        class="w-8 h-8 rounded-lg bg-gradient-to-br from-rose-100 to-pink-100 flex items-center justify-center">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="px-4 py-3 space-y-1">
            ...
            @if (Auth::user()->canAny(['view reports', 'generate reports', 'view inventory reports', 'view sales reports']) ||
                    Auth::user()->hasRole(['admin', 'super-admin']))
                <div class="border-t border-gray-100 pt-3">
            ...
            @if (Auth::user()->hasRole('super-admin') || Auth::user()->hasRole('admin'))
                <div class="border-t border-gray-100 pt-3">
                    <h3
                        class="text-xs font-semibold uppercase tracking-wider px-4 mb-2
