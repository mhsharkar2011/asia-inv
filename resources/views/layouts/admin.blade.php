...
<body class="font-sans antialiased gradient-bg" x-data="{ sidebarOpen: window.innerWidth >= 1024 }">
    <!-- Loading Overlay -->
    <div id="loadingOverlay" class="fixed inset-0 bg-white/80 backdrop-blur-sm z-[9999] flex items-center justify-center hidden">
        <div class="text-center space-y-4">
            <div class="relative">
                <div class="w-20 h-20 rounded-full border-4 border-gray-200"></div>
                <div class="w-20 h-20 rounded-full border-4 border-blue-500 border-t-transparent absolute top-0 left-0 animate-spin"></div>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex flex-1">
            ...
            <!-- Sidebar -->
            <aside class="fixed lg:sticky top-[var(--header-height)] left-0 h-[calc(100vh-var(--header-height))] bg-white border-r border-gray-200/50 z-40 transition-all duration-300 ease-in-out overflow-y-auto shadow-xl lg:shadow-none"
                ...
                <div class="p-4 sm:p-6 lg:p-8">
                                ...
                                <div class="space-y-2">
                                    ...
                                    @else
                                        <div class="flex items-center gap-3">
                                            @if(isset($pageIcon))
                                                <div class="p-2 bg-gradient-to-br from-primary/10 to-accent/10 rounded-xl">
                                                    <i class="{{ $pageIcon }} text-xl text-primary"></i>
                                                </div>
                                            @endif
                                            <div>
                                                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">{{ $pageTitle ?? 'Page Title' }}</h1>
                    ...
                    <div class="mb-8 space-y-4">
                        ...
                        @foreach(['success', 'error', 'warning', 'info'] as $type)
                            @if(session($type))
                                <div class="flex items-center p-4 rounded-xl border-l-4 bg-gradient-to-r
                        ...
                        <!-- Validation Errors -->
                        @if($errors->any())
                            <div class="p-4 rounded-xl bg-gradient-to-r from-red-50 to-rose-50 border-l-4 border-red-500">
                ...
                <footer class="mt-4 py-3 px-2 sm:px-3 lg:px-4 border-t border-gray-200/50">
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="flex items-left gap-4">
                            <a href="#" class="text-sm text-gray-600 hover:text-primary transition-colors inline-flex items-center gap-1.5">
            ...
            <div class="w-full max-w-2xl">
                <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <div class="p-6 border-b border-gray-200">
                        <div class="relative">
                            <input type="text"
                                   placeholder="Search for products, customers, orders, reports..."
