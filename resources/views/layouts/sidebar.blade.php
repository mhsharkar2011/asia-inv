        ...
        <ul class="space-y-1">
            ...
            @if (Auth::user()->hasRole('super-admin') || Auth::user()->hasRole('admin'))
                ...
                <div class="relative" x-data="{ open: false }">
                   ...
                   @if ($isSuperAdmin) text-rose-600 hover:text-rose-700 hover:bg-rose-50
                   @else text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 @endif"
                        :class="open ? '@if ($isSuperAdmin) bg-rose-50 @else bg-indigo-50 @endif' : ''">
                        @if ($isSuperAdmin)
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                        ...
                        class="absolute top-full left-0 mt-2 w-72 bg-white rounded-xl shadow-xl border py-2 z-50
                @if ($isSuperAdmin) border-rose-100 @else border-indigo-100 @endif">
        ...
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <div
                    ...
                    <span
                        class="text-white text-sm font-semibold">{{ strtoupper(substr(Auth::user()->name, 0, 1)) }}</span>
                </div>
            </div>
            <div class="ml-3 flex-1">
                ...
                <div class="flex flex-wrap gap-1 mt-1">
                    ...
                    @if (Auth::user()->hasRole('super-admin'))
                        <span
                            class="text-xs px-2 py-0.5 bg-gradient-to-r from-red-500 to-pink-600 text-white rounded-full animate-pulse">
                            ⚡ SUPER ADMIN
                        </span>
                    @endif
                </div>
