<nav class="flex flex-col h-full bg-white border-r border-gray-200">
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3">
        <ul class="space-y-1">
                ...
                $sections = [
                    ...
                    'purchase' => [
                        ...
                        'items' => [
                            ...
                            ['route' => 'purchase.purchase-orders.index', 'name' => 'Purchase Orders', 'permission' => 'view purchase orders', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                        ]
                    ],
                    'sales' => [
                        'title' => 'Sales',
                        ...
                        'items' => [
                            ...
                            ['route' => 'sales.sales-orders.index', 'name' => 'Sales Orders', 'permission' => 'view sales orders', 'icon' => 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z'],
                            ['route' => 'sales.invoices.index', 'name' => 'Sales Invoices', 'permission' => 'view invoices', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                        ]
                    ],
                ];
            @endphp
            ...
            <!-- Administration Section (For Admins or specific roles) -->
            @hasanyrole('admin|super-admin')
                @php
                    $adminSection = [
                        ...
                        'items' => [
                            ['route' => 'admin.users.index', 'name' => 'Users', 'permission' => 'view users', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 0c-.281.046-.562.086-.844.119A10.04 10.04 0 0115 19.5a10.01 10.01 0 01-5.656-1.724m10.656-8.776A10.023 10.023 0 0115 3.5c.67 0 1.32.087 1.944.249m10.656 8.776A10.023 10.023 0 0021 12.5c0 .527-.043 1.047-.124 1.558M3.5 10.5h.01m13.49 5h.01M3.5 15.5h.01'],
                            ['route' => 'admin.companies.index', 'name' => 'Companies', 'permission' => 'view companies', 'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
                            ['route' => 'admin.roles.index', 'name' => 'Roles & Permissions', 'permission' => 'view roles', 'icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z'],
            ...
            <!-- Reports Section (With Permission Check) -->
            @can('view reports')
            <li x-data="{ open: {{ request()->is('reports*') ? 'true' : 'false' }} }" class="mt-6">
                <button @click="open = !open"
                        class="w-full flex items-center justify-between px-3 py-2.5 text-sm rounded-lg text-gray-700 hover:bg-gray-100 transition-colors">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="ml-3">
                ...
                <p class="text-xs text-gray-500 capitalize">
                    ...
                    @elseif(Auth::user()->hasRole('sales'))
                        <span class="px-2 py-1 text-xs bg-purple-100 text-purple-800 rounded-full">Sales</span>
                    @elseif(Auth::user()->hasRole('purchase'))
                        <span class="px-2 py-1 text-xs bg-yellow-100 text-yellow-800 rounded-full">Purchase</span>
                    @else
