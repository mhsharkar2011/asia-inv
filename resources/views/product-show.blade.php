...
@section('content')
    ...
    <a href="{{ route('cart.index') }}" class="relative group">
        <svg class="w-6 h-6 text-gray-600 group-hover:text-blue-600 transition-colors" fill="none" stroke="currentColor"
            viewBox="0 0 24 24">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        @if ($relatedProduct->is_active && $relatedProduct->stock_quantity > 0)
                                            <button type="button"
                                                onclick="event.preventDefault(); addRelatedToCart({{ $relatedProduct->id }})"
