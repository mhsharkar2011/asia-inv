                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="name" id="name" value="{{ old('name') }}"
                                            class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('name') border-red-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="code" id="code" value="{{ old('code') }}"
                                            class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('code') border-red-300 @enderror"
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">
                                        Unique identifier for this branch. Auto-generated from name.
                                    </p>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <select name="company_id" id="company_id"
                                                class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('company_id') border-red-300 @enderror"
                                                required>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="address" id="address" rows="3"
                                        class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('address') border-red-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="city" id="city" value="{{ old('city') }}"
                                            class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('city') border-red-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="country" id="country"
                                            value="{{ old('country') }}"
                                            class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('country') border-red-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="tel" name="phone" id="phone" value="{{ old('phone') }}"
                                            class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('phone') border-red-300 @enderror"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="email" name="email" id="email" value="{{ old('email') }}"
                                            class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('email') border-red-300 @enderror"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="description" id="description" rows="3"
                                        class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 @error('description') border-red-300 @enderror"
                                        ...
                                        <label for="is_active" class="flex items-center cursor-pointer">
                                            <div class="relative">
                                                <input type="checkbox" name="is_active" id="is_active" value="1"
                                                    {{ old('is_active', 1) ? 'checked' : '' }} class="sr-only">
                                                <div
                                                    class="block bg-gray-300 w-14 h-8 rounded-full transition-all duration-300">
                                                </div>
                                                <div
                                                    class="dot absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition-all duration-300">
                                                </div>
                                            </div>
                                            <div class="ml-3 text-sm font-medium text-gray-900">
                                                <span
                                                    id="statusText">{{ old('is_active', 1) ? 'Active' : 'Inactive' }}</span>
                                            </div>
                                        </label>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (nameInput && codeInput) {
                ...
                // Also generate on input for better UX
