    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div
                    class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600 mt-2">
                                {{ $stats['active'] ?? $branches->where('is_active', true)->count() }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-red-600 mt-2">
                                {{ $stats['inactive'] ?? $branches->where('is_active', false)->count() }}</p>
                        </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                    <form action="{{ route('admin.branches.index') }}" method="GET"
                        ...
                        <div class="flex space-x-3">
                            <!-- Status Filter -->
                            <select name="status"
                                class="px-4 py-3 border-0 bg-gray-50 rounded-xl focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-200">
                ...
                <div class="divide-y divide-gray-100">
                    @forelse($branches as $branch)
                        <div
                            class="group p-6 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 transition-all duration-200">
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="relative">
                                        <div
                                            class="w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg bg-gradient-to-br from-indigo-500 to-indigo-600">
                                ...
                                <div class="flex-grow">
                                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                        ...
                                        <div class="mt-2 md:mt-0">
                                            @if ($branch->is_active)
                                                <span
                                                    class="px-3 py-1.5 text-xs font-bold rounded-full bg-gradient-to-r from-green-100 to-green-200 text-green-800">
                                            ...
                                            @else
                                                <span
                                                    class="px-3 py-1.5 text-xs font-bold rounded-full bg-gradient-to-r from-red-100 to-red-200 text-red-800">
                                                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="space-y-1">
                                                @if ($branch->address)
                                                    <div class="flex items-center text-sm text-gray-600">
                                                        ...
                                                        <span
                                                            class="truncate">{{ Str::limit($branch->address, 40) }}</span>
                                                    </div>
                                                @endif
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="hidden absolute right-0 mt-2 w-56 rounded-xl shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10"
                                                ...
                                                <div class="py-2">
                                                    ...
                                                    <a href="{{ route('admin.branches.edit', $branch) }}"
                                                        class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200">
                                                        <svg class="w-4 h-4 mr-3 text-amber-500" fill="none"
                                                            stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                                                d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                    ...
                                                    @if ($branch->is_active)
                                                        <form
                                                            action="{{ route('admin.branches.toggle-status', $branch) }}"
                                                            method="POST">
                                                            @csrf
                                                            <button type="submit"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-6">
                    <form action="{{ route('admin.branches.import') }}" method="POST" enctype="multipart/form-data"
                        id="importForm">
                        @csrf
                        <div class="space-y-6">
                            <!-- File Upload -->
                            <div>
                                ...
                                <div
                                    class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-2xl hover:border-blue-500 transition-colors duration-200">
            ...
            if (selectAll && checkboxes.length > 0) {
                ...
                if (bulkActivateBtn) {
                    bulkActivateBtn.addEventListener('click', () => {
                        ...
                        if (ids.length > 0 && confirm(
                                `Activate ${ids.length} selected branch${ids.length > 1 ? 'es' : ''}?`)) {
                ...
                if (bulkDeactivateBtn) {
                    bulkDeactivateBtn.addEventListener('click', () => {
                        const ids = getSelectedIds();
                        if (ids.length > 0 && confirm(
                                `Deactivate ${ids.length} selected branch${ids.length > 1 ? 'es' : ''}?`)) {
                ...
                if (bulkDeleteBtn) {
                    bulkDeleteBtn.addEventListener('click', () => {
                        const ids = getSelectedIds();
                        if (ids.length > 0 && confirm(
                                `Delete ${ids.length} selected branch${ids.length > 1 ? 'es' : ''}? This action cannot be undone.`
                            )) {
